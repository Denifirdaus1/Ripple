...
class _NoteEditorViewState extends State<_NoteEditorView> {
  ...
  Future<void> _handleImageUpload() async {
    ...
    try {
      // Upload returns public URL directly (bucket is public)
      final publicUrl = await service.pickAndUploadImage(
      ...
      if (publicUrl != null) {
        ...
        // Insert the public URL directly - no expiration!
        _controller.replaceText(
          index,
          length,
          BlockEmbed.image(publicUrl),
          null,
        );
      }
    } catch (e) {
